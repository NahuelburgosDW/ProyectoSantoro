...
namespace proyecto_santoro.Controllers
{
    public class Table1Controller : Controller
    {
        ...
        public Table1Controller(ProyectoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Table1s != null ? 
                          ...
                          Problem("Entity set 'ProyectoContext.Table1s'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Usuario,Contraseña")] Table1 table1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Usuario,Contraseña")] Table1 table1)
        {
            if (id != table1.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProyectoContext.Table1s'  is null.");
            }
            var table1 = await _context.Table1s.FindAsync(id);
            if (table1 != null)
            {
